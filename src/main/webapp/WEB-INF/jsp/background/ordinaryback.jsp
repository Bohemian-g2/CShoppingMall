        ...
        <form class="am-form tjlanmu" style="width: 90%;margin: auto">
            <div class="am-form-group">
                ...
                <div class="you" style="float: right;width: 80%">
                    <input type="text" class="am-input-sm" id="adminName" placeholder="${sessionScope.admin.adminName}">
                </div>
            </div>
            <div class="am-form-group">
                <div class="zuo">联系方式</div>
                <div class="you">
                    <input type="text" class="am-input-sm" id="adminPhone" placeholder="${sessionScope.admin.adminPhone}">
                </div>
            </div>
            <div class="am-form-group">
...
<div class="am-cf admin-main">
    ...
    <div class="nav-navicon admin-main admin-sidebar">
        <div class="sideMenu am-icon-dashboard" style="color:#aeb2b7; margin: 10px 0 0 0;"> 欢迎普通管理员：${sessionScope.admin.adminName}</div>
    ...
    <div class=" admin-content">
        ...
        <div class="daohang">
            <ul id="leader_title">
                <li><button type="button" class="am-btn am-btn-default am-radius am-btn-xs" onclick="loadPage('${pageContext.request.contextPath}/background/UserList','UserList');" > 首页</button></li>
            </ul>
        </div>
        <%--页面内容--%>
        <div id="content"></div>
