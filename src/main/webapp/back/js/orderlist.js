...
$(function(){
    ...
    function build_commodity_information(result){
        ...
        $.each(result.list,function (index,item) {
            ...
            append(detail_btn);
            tr.append(id).append(name).append(address).append(rec_name).append(createTime).append(way).append(total).append(carriage).append(btn).appendTo("#order_list tbody");
        });
    }
