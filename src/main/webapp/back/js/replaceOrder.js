...
$(function(){
    ...
    function build_commodity_information(result){
        ...
        $.each(result.list,function (index,item) {
            ...
            //两个按钮
            var detail_btn = $("<button type='button' class='indent_detail_btn am-btn am-btn-default am-btn-xs am-text-success am-round' title='订单详情' data-am-modal={target:'#replace_detail_modal'}></button>").
